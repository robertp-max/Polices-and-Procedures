...
const pages = [
  {url: "/ces/calendar", name: "ces-calendar-1to1"},
  {url: "/journey", name: "journey-overview-1to1"},
  {url: "/journey/v1-journey", name: "journey-v1-1to1"},
  {url: "/ces/board", name: "ces-board-1to1"}
];
