# Reviewer Checklist — HR-FM-016
Auditor compliance verification checklist:

- [ ] **Patient Demographics verified**: Patient name, MRN, and DOB matches synthetic record `MOCK-PT-Q2-0017` exactly.
- [ ] **Clinician details verified**: License expiration and credentials verified against `MOCK-CLIN-Q2-0002`.
