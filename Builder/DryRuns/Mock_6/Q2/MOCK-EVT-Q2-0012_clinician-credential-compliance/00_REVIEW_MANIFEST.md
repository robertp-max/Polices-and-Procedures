# Brad Training Compliance Review Manifest — MOCK-EVT-Q2-0012
**Event Type**: clinician_credential_compliance  
**Audit Date**: 2026-06-01  
**Status**: BRAD-DRAFT — Human Review Required  
**Payer**: Mock Medicare A  

## Included Files in this Packet:
1. **01_FILLED_CARE_INDEED_FORMS/**
   - [`HR-FM-016_clinical-staff-competency-validation-checklist_brad-filled.pdf`](file:///C:/AI/Git/training/HomeHealth/Policies_and_Procedures/Builder/DryRuns/Mock_6/Q2/MOCK-EVT-Q2-0012_clinician-credential-compliance/01_FILLED_CARE_INDEED_FORMS/HR-FM-016_clinical-staff-competency-validation-checklist_brad-filled.pdf) — Primary signable actual Care Indeed form.
2. **02_FIELD_SOURCE_CROSSWALKS/**
   - `HR-FM-016_field-source-crosswalk.md` — Maps form fields back to the synthetic JSON source records.
3. **03_REVIEW_CHECKLISTS/**
   - `HR-FM-016_review-checklist.md` — Compliance validation checklist for the auditor.
