# Component Documentation: src__policy__components__FormSignatureContext

## Overview
- Source file: src/policy/components/FormSignatureContext.tsx
- Exported symbols: DEMO_SESSION, DEMO_STAFF, signerNanoid, fmtSignTs, SignatureCtx, useSignatureCtx
- Component classification: Application component

## UI Breakdown
- JSX elements detected: string, SignatureCtxValue
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/FormSignatureContext.tsx.
