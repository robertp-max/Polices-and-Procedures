# Component Documentation: src__policy__components__ui__SurfaceCard

## Overview
- Source file: src/policy/components/ui/SurfaceCard.tsx
- Exported symbols: SurfaceCard
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: HTMLDivElement, NonNullable, SurfaceCardProps, div
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/SurfaceCard.tsx.
