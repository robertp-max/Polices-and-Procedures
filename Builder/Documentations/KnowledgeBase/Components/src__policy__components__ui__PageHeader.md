# Component Documentation: src__policy__components__ui__PageHeader

## Overview
- Source file: src/policy/components/ui/PageHeader.tsx
- Exported symbols: PageHeader
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: header, div, h1, p
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/PageHeader.tsx.
