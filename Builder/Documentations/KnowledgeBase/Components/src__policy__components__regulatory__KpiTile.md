# Component Documentation: src__policy__components__regulatory__KpiTile

## Overview
- Source file: src/policy/components/regulatory/KpiTile.tsx
- Exported symbols: KpiTile
- Component classification: Application component

## UI Breakdown
- JSX elements detected: button, span, div
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/regulatory/KpiTile.tsx.
