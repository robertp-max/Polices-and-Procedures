# Component Documentation: src__policy__components__regulatory__ModalShell

## Overview
- Source file: src/policy/components/regulatory/ModalShell.tsx
- Exported symbols: ModalShell, DrawerShell
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, span, header, h3, p, button, X, footer, aside
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/regulatory/ModalShell.tsx.
