# Component Documentation: src__policy__components__regulatory__EventChip

## Overview
- Source file: src/policy/components/regulatory/EventChip.tsx
- Exported symbols: EventChip
- Component classification: Application component

## UI Breakdown
- JSX elements detected: MandateType, button, span, div, p, FileWarning, Ban, AlertTriangle, Clock
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/regulatory/EventChip.tsx.
- Dependency imports (first 15): lucide-react
...
## Dependencies
- Internal and external imports: lucide-react
