# Component Documentation: src__policy__components__pm__NotificationCenter

## Overview
- Source file: src/policy/components/pm/NotificationCenter.tsx
- Exported symbols: NotificationCenter
- Component classification: Application component

## UI Breakdown
- JSX elements detected: NotificationKind, div, button, svg, path, span, header, h3, ul, li
- Store hooks detected: usePmNotificationStore
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/pm/NotificationCenter.tsx.
- Dependency imports (first 15): react, @/policy/pm/notificationStore, @/policy/pm/notifications/decider
...
## Dependencies
- Internal and external imports: react, @/policy/pm/notificationStore, @/policy/pm/notifications/decider
