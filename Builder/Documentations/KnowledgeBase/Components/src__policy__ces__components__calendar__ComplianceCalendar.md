# Component Documentation: src__policy__ces__components__calendar__ComplianceCalendar

## Overview
- Source file: src/policy/ces/components/calendar/ComplianceCalendar.tsx
- Exported symbols: ComplianceCalendar
- Component classification: Application component

## UI Breakdown
- JSX elements detected: ComplianceDomain, string, div, h1, p, Legend, Anchor, PenLine, Repeat, RotateCcw, CesCard, span, CalendarDay, EventAnchorMarker, SignatureWindowBlock
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/calendar/ComplianceCalendar.tsx.
- Dependency imports (first 15): react, lucide-react, ../../theme, @/policy/compliance-execution, ../primitives
...
## Dependencies
- Internal and external imports: react, lucide-react, ../../theme, @/policy/compliance-execution, ../primitives
