# Component Documentation: src__policy__ces__components__primitives

## Overview
- Source file: src/policy/ces/components/primitives.tsx
- Exported symbols: CesCard, ComplianceStateBadge, PhaseIndicator, AuditReadinessTag, DomainRiskDot, UserAvatar, EscalationTimer, KV
- Component classification: Application component

## UI Breakdown
- JSX elements detected: section, header, h3, div, ComplianceState, span, AuditReadiness
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/primitives.tsx.
- Dependency imports (first 15): react, ../theme
...
## Dependencies
- Internal and external imports: react, ../theme
