# Component Documentation: src__policy__onboarding-v2__components__PolicyVersionLink

## Overview
- Source file: src/policy/onboarding-v2/components/PolicyVersionLink.tsx
- Exported symbols: PolicyVersionLink
- Component classification: Application component

## UI Breakdown
- JSX elements detected: a, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/onboarding-v2/components/PolicyVersionLink.tsx.
- Dependency imports (first 15): ../types
...
## Dependencies
- Internal and external imports: ../types
