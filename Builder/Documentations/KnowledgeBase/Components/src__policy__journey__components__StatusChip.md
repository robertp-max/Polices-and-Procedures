# Component Documentation: src__policy__journey__components__StatusChip

## Overview
- Source file: src/policy/journey/components/StatusChip.tsx
- Exported symbols: StatusChip
- Component classification: Application component

## UI Breakdown
- JSX elements detected: Lock, Clock, CheckCircle2, XCircle, AlertTriangle, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/journey/components/StatusChip.tsx.
