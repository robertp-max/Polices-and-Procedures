# Component Documentation: src__policy__components__ui__ActionButton

## Overview
- Source file: src/policy/components/ui/ActionButton.tsx
- Exported symbols: ActionButton
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: ButtonHTMLAttributes, HTMLButtonElement, button, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/ActionButton.tsx.
