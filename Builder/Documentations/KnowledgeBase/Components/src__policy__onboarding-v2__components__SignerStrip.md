# Component Documentation: src__policy__onboarding-v2__components__SignerStrip

## Overview
- Source file: src/policy/onboarding-v2/components/SignerStrip.tsx
- Exported symbols: SignerStrip
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, I, span, button
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/onboarding-v2/components/SignerStrip.tsx.
- Dependency imports (first 15): lucide-react, ../types
...
## Dependencies
- Internal and external imports: lucide-react, ../types
