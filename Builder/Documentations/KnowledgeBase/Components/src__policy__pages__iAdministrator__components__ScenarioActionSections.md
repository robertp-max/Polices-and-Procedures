# Component Documentation: src__policy__pages__iAdministrator__components__ScenarioActionSections

## Overview
- Source file: src/policy/pages/iAdministrator/components/ScenarioActionSections.tsx
- Exported symbols: ScenarioActionSections
- Component classification: Page-scoped component

## UI Breakdown
- JSX elements detected: section, div, span, h2, p, Section, ol, li, PriorityPill, MetaPill, ArtifactGrid, ul, Quote, Icon, button
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/pages/iAdministrator/components/ScenarioActionSections.tsx.
- Dependency imports (first 15): lucide-react, react, ../lib/classifyScenario
...
## Dependencies
- Internal and external imports: lucide-react, react, ../lib/classifyScenario
