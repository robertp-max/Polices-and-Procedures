# Component Documentation: src__policy__onboarding-v2__components__EvidencePanel

## Overview
- Source file: src/policy/onboarding-v2/components/EvidencePanel.tsx
- Exported symbols: EvidencePanel
- Component classification: Application component

## UI Breakdown
- JSX elements detected: EvidenceObjectType, div, ul, li, StatusPill, span, label, select, option, input, button, Upload, FileText, PolicyVersionLink, RefreshCw
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/onboarding-v2/components/EvidencePanel.tsx.
- Dependency imports (first 15): react, lucide-react, ../types, ./StatusPill, ../store/onboardingV2Store, ./PolicyVersionLink
...
## Dependencies
- Internal and external imports: react, lucide-react, ../types, ./StatusPill, ../store/onboardingV2Store, ./PolicyVersionLink
