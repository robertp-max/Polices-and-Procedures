# Component Documentation: src__policy__journey__components__PhaseRail

## Overview
- Source file: src/policy/journey/components/PhaseRail.tsx
- Exported symbols: PhaseRail
- Component classification: Application component

## UI Breakdown
- JSX elements detected: ShieldAlert, ClipboardCheck, UserCheck, Users, Award, RotateCw, Siren, div, button, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/journey/components/PhaseRail.tsx.
- Dependency imports (first 15): lucide-react, @/policy/journey/types/journey
...
## Dependencies
- Internal and external imports: lucide-react, @/policy/journey/types/journey
