# Component Documentation: src__policy__components__pm__PmFilterBar

## Overview
- Source file: src/policy/components/pm/PmFilterBar.tsx
- Exported symbols: applyPmFilter, PmFilterBar
- Component classification: Application component

## UI Breakdown
- JSX elements detected: K, div, input, FacetGroup, Chip, button, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/pm/PmFilterBar.tsx.
- Dependency imports (first 15): react, @/policy/pm/types
...
## Dependencies
- Internal and external imports: react, @/policy/pm/types
