# Component Documentation: src__policy__components__pm__SprintReviewPage

## Overview
- Source file: src/policy/components/pm/SprintReviewPage.tsx
- Exported symbols: SprintReviewPage
- Component classification: Application component

## UI Breakdown
- JSX elements detected: string, div, header, h1, p, button, select, option, section, h2, table, thead, tr, th, tbody
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/pm/SprintReviewPage.tsx.
