# Component Documentation: src__policy__ces__components__board__ExecutionUnitCard

## Overview
- Source file: src/policy/ces/components/board/ExecutionUnitCard.tsx
- Exported symbols: ExecutionUnitCard
- Component classification: Application component

## UI Breakdown
- JSX elements detected: article, div, h4, PhaseIndicator, ComplianceStateBadge, AuditReadinessTag, AlertCircle, span, UserAvatar, EscalationTimer, FileText, Calendar
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/board/ExecutionUnitCard.tsx.
- Dependency imports (first 15): lucide-react, ../../types, ../../theme
...
## Dependencies
- Internal and external imports: lucide-react, ../../types, ../../theme
