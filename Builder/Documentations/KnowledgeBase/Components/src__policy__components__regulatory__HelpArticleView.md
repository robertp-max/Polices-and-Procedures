# Component Documentation: src__policy__components__regulatory__HelpArticleView

## Overview
- Source file: src/policy/components/regulatory/HelpArticleView.tsx
- Exported symbols: useHelpArticleForEvent, HelpArticleInline, HelpArticleModal
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, h4, p, span, Clock, SectionHeading, BookOpen, CheckCircle2, ol, li, PolicyRef, button, ExternalLink, HelpArticleModal, ModalShell
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/regulatory/HelpArticleView.tsx.
- Dependency imports (first 15): react, @/policy/data/regulatoryEvents, @/policy/data/helpArticles, ./ModalShell, ./Primitives
...
## Dependencies
- Internal and external imports: react, @/policy/data/regulatoryEvents, @/policy/data/helpArticles, ./ModalShell, ./Primitives
