# Component Documentation: src__policy__ces__components__workloads__WorkloadDistribution

## Overview
- Source file: src/policy/ces/components/workloads/WorkloadDistribution.tsx
- Exported symbols: WorkloadDistribution
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, h1, p, SummaryStat, Users, CesCard, table, thead, tr, Th, tbody, Td, UserAvatar, span, CapacityBar
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/workloads/WorkloadDistribution.tsx.
- Dependency imports (first 15): react, lucide-react, ../../theme, @/policy/compliance-execution, ../../types, ../primitives
...
## Dependencies
- Internal and external imports: react, lucide-react, ../../theme, @/policy/compliance-execution, ../../types, ../primitives
