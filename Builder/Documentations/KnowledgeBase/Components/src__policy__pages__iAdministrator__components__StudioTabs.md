# Component Documentation: src__policy__pages__iAdministrator__components__StudioTabs
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/pages/iAdministrator/components/StudioTabs.tsx.
- Dependency imports (first 15): lucide-react, ../lib/responseTypes, @/policy/components/ui
...
## Dependencies
- Internal and external imports: lucide-react, ../lib/responseTypes, @/policy/components/ui
