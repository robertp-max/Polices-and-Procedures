# Component Documentation: src__policy__components__DraftBanner

## Overview
- Source file: src/policy/components/DraftBanner.tsx
- Exported symbols: DraftBanner
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, AlertTriangle, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/DraftBanner.tsx.
