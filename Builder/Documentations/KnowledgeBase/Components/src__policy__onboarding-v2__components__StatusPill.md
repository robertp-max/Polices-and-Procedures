# Component Documentation: src__policy__onboarding-v2__components__StatusPill

## Overview
- Source file: src/policy/onboarding-v2/components/StatusPill.tsx
- Exported symbols: StatusPill
- Component classification: Application component

## UI Breakdown
- JSX elements detected: Tone, UnitStatus, BatchStatus, EvidenceStatus, SignatureStatus, GateOutcome, string, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/onboarding-v2/components/StatusPill.tsx.
- Dependency imports (first 15): react, ../types
...
## Dependencies
- Internal and external imports: react, ../types
