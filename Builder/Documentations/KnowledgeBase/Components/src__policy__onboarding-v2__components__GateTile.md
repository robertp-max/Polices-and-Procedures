# Component Documentation: src__policy__onboarding-v2__components__GateTile

## Overview
- Source file: src/policy/onboarding-v2/components/GateTile.tsx
- Exported symbols: GateTile
- Component classification: Application component

## UI Breakdown
- JSX elements detected: button, div, Icon, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/onboarding-v2/components/GateTile.tsx.
- Dependency imports (first 15): lucide-react, ../engine/gates, ../engine/gates
...
## Dependencies
- Internal and external imports: lucide-react, ../engine/gates, ../engine/gates
