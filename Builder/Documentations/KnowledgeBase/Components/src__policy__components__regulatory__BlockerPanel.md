# Component Documentation: src__policy__components__regulatory__BlockerPanel

## Overview
- Source file: src/policy/components/regulatory/BlockerPanel.tsx
- Exported symbols: BlockerPanel
- Component classification: Application component

## UI Breakdown
- JSX elements detected: EnforcementRiskLevel, BlockerSeverity, Blocker, string, div, span, p, button, section, ul, li
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/regulatory/BlockerPanel.tsx.
- Dependency imports (first 15): react, @/policy/enforcement/types
...
## Dependencies
- Internal and external imports: react, @/policy/enforcement/types
