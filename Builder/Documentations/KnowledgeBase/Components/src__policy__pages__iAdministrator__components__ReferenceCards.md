# Component Documentation: src__policy__pages__iAdministrator__components__ReferenceCards

## Overview
- Source file: src/policy/pages/iAdministrator/components/ReferenceCards.tsx
- Exported symbols: ReferenceCards
- Component classification: Page-scoped component

## UI Breakdown
- JSX elements detected: section, header, span, Group, div, ReferenceCard, button, Icon, TypeChip, IntentChip
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/pages/iAdministrator/components/ReferenceCards.tsx.
