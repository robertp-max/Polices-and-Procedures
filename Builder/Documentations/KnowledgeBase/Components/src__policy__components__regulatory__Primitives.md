# Component Documentation: src__policy__components__regulatory__Primitives

## Overview
- Source file: src/policy/components/regulatory/Primitives.tsx
- Exported symbols: DomainDot, DomainBadge, UrgencyChip, PolicyRef, EvidenceDot, Panel
- Component classification: Application component

## UI Breakdown
- JSX elements detected: span, DomainDot, section, header, div, h3
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/regulatory/Primitives.tsx.
