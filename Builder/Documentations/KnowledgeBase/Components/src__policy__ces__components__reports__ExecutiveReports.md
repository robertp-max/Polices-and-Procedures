# Component Documentation: src__policy__ces__components__reports__ExecutiveReports

## Overview
- Source file: src/policy/ces/components/reports/ExecutiveReports.tsx
- Exported symbols: ExecutiveReports
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, h1, p, CesCard, BarChart, LineChart, span, svg, line, g, rect, text, path, circle
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/reports/ExecutiveReports.tsx.
- Dependency imports (first 15): ../../theme, @/policy/compliance-execution, ../../types, ../primitives
...
## Dependencies
- Internal and external imports: ../../theme, @/policy/compliance-execution, ../../types, ../primitives
