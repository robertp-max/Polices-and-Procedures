# Component Documentation: src__policy__pages__iAdministrator__components__RiskBadge

## Overview
- Source file: src/policy/pages/iAdministrator/components/RiskBadge.tsx
- Exported symbols: RiskBadge, ConfidencePill
- Component classification: Page-scoped component

## UI Breakdown
- JSX elements detected: RiskLevel, Confidence, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/pages/iAdministrator/components/RiskBadge.tsx.
