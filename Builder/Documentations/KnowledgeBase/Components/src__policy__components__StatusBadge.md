# Component Documentation: src__policy__components__StatusBadge

## Overview
- Source file: src/policy/components/StatusBadge.tsx
- Exported symbols: StatusBadge
- Component classification: Application component

## UI Breakdown
- JSX elements detected: LifecycleStatus, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/StatusBadge.tsx.
- Dependency imports (first 15): @/policy/types
...
## Dependencies
- Internal and external imports: @/policy/types
