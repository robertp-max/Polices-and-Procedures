# Component Documentation: src__policy__pages__iAdministrator__components__StructuredAnswer

## Overview
- Source file: src/policy/pages/iAdministrator/components/StructuredAnswer.tsx
- Exported symbols: StructuredAnswer
- Component classification: Page-scoped component

## UI Breakdown
- JSX elements detected: string, section, div, span, ConfidencePill, button, RiskBadge, p, em, FileText, ShieldAlert, BookOpen, Search, ul, li
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/pages/iAdministrator/components/StructuredAnswer.tsx.
- Dependency imports (first 15): lucide-react, ../lib/responseTypes, ./RiskBadge
...
## Dependencies
- Internal and external imports: lucide-react, ../lib/responseTypes, ./RiskBadge
