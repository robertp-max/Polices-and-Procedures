# Component Documentation: src__policy__journey__components__EmployeePicker

## Overview
- Source file: src/policy/journey/components/EmployeePicker.tsx
- Exported symbols: EmployeePicker
- Component classification: Application component

## UI Breakdown
- JSX elements detected: label, User, span, select, option
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/journey/components/EmployeePicker.tsx.
- Dependency imports (first 15): @/policy/journey/stores/journeyStore, lucide-react
...
## Dependencies
- Internal and external imports: @/policy/journey/stores/journeyStore, lucide-react
