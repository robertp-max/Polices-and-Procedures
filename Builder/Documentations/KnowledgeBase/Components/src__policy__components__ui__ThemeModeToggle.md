# Component Documentation: src__policy__components__ui__ThemeModeToggle

## Overview
- Source file: src/policy/components/ui/ThemeModeToggle.tsx
- Exported symbols: ThemeModeToggle
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: html, button, Moon, Sun
- Store hooks detected: useCiModeStore
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/ThemeModeToggle.tsx.
- Dependency imports (first 15): lucide-react, @/policy/stores/ciModeStore
...
## Dependencies
- Internal and external imports: lucide-react, @/policy/stores/ciModeStore
