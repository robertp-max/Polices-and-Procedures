# Component Documentation: src__policy__workflows__components__WorkflowCard

## Overview
- Source file: src/policy/workflows/components/WorkflowCard.tsx
- Exported symbols: WorkflowCard
- Component classification: Application component

## UI Breakdown
- JSX elements detected: button, div, span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/workflows/components/WorkflowCard.tsx.
- Dependency imports (first 15): ../brand, @/policy/types/workflow
...
## Dependencies
- Internal and external imports: ../brand, @/policy/types/workflow
