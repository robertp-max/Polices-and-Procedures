# Component Documentation: src__policy__components__UniversalNavControls

## Overview
- Source file: src/policy/components/UniversalNavControls.tsx
- Exported symbols: UniversalNavControls
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, button, ChevronLeft, ChevronRight
- Store hooks detected: useNavStore, useShellStore
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/UniversalNavControls.tsx.
- Dependency imports (first 15): lucide-react, react-router-dom, @/policy/stores/navStore, @/policy/stores/uiStore
...
## Dependencies
- Internal and external imports: lucide-react, react-router-dom, @/policy/stores/navStore, @/policy/stores/uiStore
