# Component Documentation: src__policy__components__ui__EmptyState

## Overview
- Source file: src/policy/components/ui/EmptyState.tsx
- Exported symbols: EmptyState
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: div
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/EmptyState.tsx.
