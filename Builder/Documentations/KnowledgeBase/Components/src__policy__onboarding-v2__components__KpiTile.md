# Component Documentation: src__policy__onboarding-v2__components__KpiTile

## Overview
- Source file: src/policy/onboarding-v2/components/KpiTile.tsx
- Exported symbols: KpiTile
- Component classification: Application component

## UI Breakdown
- JSX elements detected: button, div
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/onboarding-v2/components/KpiTile.tsx.
- Dependency imports (first 15): GAP: No import statements detected.
...
## Dependencies
- Internal and external imports: GAP: No imports detected.
