# Component Documentation: src__policy__ces__components__details__WorkflowDrawer

## Overview
- Source file: src/policy/ces/components/details/WorkflowDrawer.tsx
- Exported symbols: WorkflowDrawer
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, aside, header, h2, ComplianceStateBadge, AuditReadinessTag, button, X, section, KV, EscalationTimer, NonSkippableTimeline, EvidenceStatusPanel, SignatureRoster, ShieldAlert
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/details/WorkflowDrawer.tsx.
- Dependency imports (first 15): react, lucide-react, ../../theme, ../../hooks/useExecutionEnforcement, ../../hooks/useEvidenceTracker, @/policy/compliance-execution
...
## Dependencies
- Internal and external imports: react, lucide-react, ../../theme, ../../hooks/useExecutionEnforcement, ../../hooks/useEvidenceTracker, @/policy/compliance-execution
