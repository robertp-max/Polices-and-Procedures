# Component Documentation: src__policy__components__ui__UtilityButton

## Overview
- Source file: src/policy/components/ui/UtilityButton.tsx
- Exported symbols: UtilityButton
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: HTMLButtonElement, button
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/UtilityButton.tsx.
