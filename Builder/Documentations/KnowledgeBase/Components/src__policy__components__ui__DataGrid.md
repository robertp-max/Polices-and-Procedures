# Component Documentation: src__policy__components__ui__DataGrid

## Overview
- Source file: src/policy/components/ui/DataGrid.tsx
- Exported symbols: DataGrid
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: DataGrid, HTMLTableElement, table, thead, tr, HTMLTableCellElement, th, tbody, HTMLTableRowElement, td
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/DataGrid.tsx.
