# Component Documentation: src__policy__components__ui__CiStatusBadge

## Overview
- Source file: src/policy/components/ui/CiStatusBadge.tsx
- Exported symbols: CiStatusBadge
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: span
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/CiStatusBadge.tsx.
