# Component Documentation: src__policy__components__ui__SectionHeader

## Overview
- Source file: src/policy/components/ui/SectionHeader.tsx
- Exported symbols: SectionHeader
- Component classification: UI primitive/component

## UI Breakdown
- JSX elements detected: div, h3
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/ui/SectionHeader.tsx.
