# Component Documentation: src__policy__components__pm__ApprovalsQueuePage

## Overview
- Source file: src/policy/components/pm/ApprovalsQueuePage.tsx
- Exported symbols: ApprovalsQueuePage
- Component classification: Application component

## UI Breakdown
- JSX elements detected: string, div, header, h1, p, label, select, option, ul, li, span, button
- Store hooks detected: usePmOverlayStore, usePmNotificationStore
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/components/pm/ApprovalsQueuePage.tsx.
- Dependency imports (first 15): react, @/policy/pm/taskProjection, @/policy/pm/pmOverlayStore, @/policy/pm/notificationStore, @/policy/pm/types, @/policy/pm/types
...
## Dependencies
- Internal and external imports: react, @/policy/pm/taskProjection, @/policy/pm/pmOverlayStore, @/policy/pm/notificationStore, @/policy/pm/types, @/policy/pm/types
