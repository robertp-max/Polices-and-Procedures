# Component Documentation: src__policy__ces__components__dashboard__CesExecutiveDashboard

## Overview
- Source file: src/policy/ces/components/dashboard/CesExecutiveDashboard.tsx
- Exported symbols: CesExecutiveDashboard
- Component classification: Application component

## UI Breakdown
- JSX elements detected: div, h1, p, AlertTriangle, Link, ChevronRight, MetricCard, ShieldCheck, FileWarning, PenLine, CesCard, span, DomainRiskDot, ul, li
...
## System Behavior
- Behavior is derived from static source analysis of src/policy/ces/components/dashboard/CesExecutiveDashboard.tsx.
- Dependency imports (first 15): react, lucide-react, react-router-dom, ../../theme, @/policy/compliance-execution
...
## Dependencies
- Internal and external imports: react, lucide-react, react-router-dom, ../../theme, @/policy/compliance-execution
