# Page Documentation: src__policy__pages__iAdministrator__components__HealthStrip
...
- Visual and interaction dependencies: lucide-react, ../lib/responseTypes, ../lib/iaClient
