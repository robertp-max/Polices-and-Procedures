# Page Documentation: src__policy__pages__GVGBPrintDocument

## Page Purpose
- Source file: src/policy/pages/GVGBPrintDocument.tsx
- Primary role: Application operational page/view.
- Exported symbols: GVGBPrintDocument

## UI Layout
- JSX elements detected: input, table, thead, tr, th, tbody, td, h2, h3, div, span, img, h1, strong, H1
- Core hooks: useEffect
