# Page Documentation: src__policy__pages__iAdministrator__components__StructuredAnswer
...
- Visual and interaction dependencies: lucide-react, ../lib/responseTypes, ./RiskBadge
