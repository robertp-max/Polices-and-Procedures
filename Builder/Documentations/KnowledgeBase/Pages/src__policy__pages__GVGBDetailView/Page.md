# Page Documentation: src__policy__pages__GVGBDetailView

## Page Purpose
- Source file: src/policy/pages/GVGBDetailView.tsx
- Primary role: Application operational page/view.
- Exported symbols: GVGBDetailView

## UI Layout
- JSX elements detected: string, div, h2, Icon, table, thead, tr, th, tbody, td, button, Card, SectionTitle, p, strong
- Core hooks: useEffect, useState, useNavigate
- Visual and interaction dependencies: react, react-router-dom, @/policy/stores/uiStore, @/policy/components/FormViewer
