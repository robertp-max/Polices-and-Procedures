# Page Documentation: src__policy__pages__iAdministrator__components__RightPanelPreview
...
- Core hooks: useEffect, useRef
- Visual and interaction dependencies: react, lucide-react, ../lib/responseTypes, ./FormRenderer, @/policy/components/ui
