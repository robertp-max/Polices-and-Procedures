# Page Documentation: src__policy__pages__iAdministrator__components__ActiveCasePanel
...
- Core hooks: useState
- Visual and interaction dependencies: react, ../lib/sessionTypes, ../lib/sessionTypes, ../lib/iaClient
