# Page Documentation: src__auth__pages__ForgotPasswordPage

## Page Purpose
- Source file: src/auth/pages/ForgotPasswordPage.tsx
- Primary role: Authentication and identity lifecycle page.
- Exported symbols: ForgotPasswordPage

## UI Layout
- JSX elements detected: AuthCard, form, label, input, p, button, div, Link
