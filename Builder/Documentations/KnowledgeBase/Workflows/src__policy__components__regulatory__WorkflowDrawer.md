# Workflow Documentation: src__policy__components__regulatory__WorkflowDrawer

## Trigger
- Trigger surfaces are inferred from source file: src/policy/components/regulatory/WorkflowDrawer.tsx.
...
## Dependencies
- Imports: react, @/policy/data/eventDisplayModel, @/policy/data/formsCatalog, ./Toast, ./ModalShell, ./Primitives
- Hooks/stores: useMemo, useState, useRegulatoryExecutionStore, useToastStore
