# Workflow Documentation: src__policy__brad__workflowSchedule

## Trigger
- Trigger surfaces are inferred from source file: src/policy/brad/workflowSchedule.ts.
...
## Dependencies
- Imports: @/policy/stores/autogenStore
- Hooks/stores: useAutogenStore, useRegulatoryExecutionStore
