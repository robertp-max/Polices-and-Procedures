# Workflow Documentation: src__policy__brad__workflowRuntime

## Trigger
- Trigger surfaces are inferred from source file: src/policy/brad/workflowRuntime.ts.
...
## Dependencies
- Imports: @/policy/stores/regulatoryExecutionStore, @/policy/stores/regulatoryExecutionStore, @/policy/data/workflows.generated, @/policy/data/regulatoryEvents, @/policy/stores/autogenStore, @/policy/audit/auditState, ./workflowKnowledge
- Hooks/stores: useRegulatoryExecutionStore, useAutogenStore
