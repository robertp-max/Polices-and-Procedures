# Workflow Documentation: src__policy__workflows__components__WorkflowCard

## Trigger
- Trigger surfaces are inferred from source file: src/policy/workflows/components/WorkflowCard.tsx.
...
## Dependencies
- Imports: ../brand, @/policy/types/workflow
