# Workflow Documentation: src__policy__help__articles__workflows-events

## Trigger
- Trigger surfaces are inferred from source file: src/policy/help/articles/workflows-events.ts.
