# Workflow Documentation: src__policy__audit__workflowInstance

## Trigger
- Trigger surfaces are inferred from source file: src/policy/audit/workflowInstance.ts.
...
## Dependencies
- Imports: react, @/policy/stores/autogenStore, @/policy/stores/enforcementStore, @/policy/enforcement/types, ./dependencyCheck
- Hooks/stores: useMemo, useAutogenStore, useRegulatoryExecutionStore, useEnforcementStore
