# Workflow Documentation: src__policy__brad__useBradWorkflow

## Trigger
- Trigger surfaces are inferred from source file: src/policy/brad/useBradWorkflow.ts.
...
## Dependencies
- Imports: react, ./workflowSchedule
- Hooks/stores: useMemo
