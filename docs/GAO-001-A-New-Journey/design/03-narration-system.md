...
- **Mandatory-reporting exact sentence:** Scenes 6 and 8 must reproduce, character-for-character, in both narration and Field Notes: "Follow agency mandatory reporting protocol immediately; do not investigate or confront; supervisor/Compliance assists with required external reporting, but required reporting must not be delayed." No paraphrase substitute is acceptable — CI-checked (Section 2).
