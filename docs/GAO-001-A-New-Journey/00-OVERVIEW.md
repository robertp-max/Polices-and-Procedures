...
- **Mandatory reporting:** the exact sentence appears character-for-character in Scenes 6 and 8, in both narration and Field Notes: *"Follow agency mandatory reporting protocol immediately; do not investigate or confront; supervisor/Compliance assists with required external reporting, but required reporting must not be delayed."* Reasonable suspicion, not proof, triggers reporting. No branch rewards investigation, confrontation, or unilateral external reporting. Scene 8's depiction is non-graphic and clinical-observational; the story ends at "reported, protocol followed" — never at a guilt/innocence verdict.
