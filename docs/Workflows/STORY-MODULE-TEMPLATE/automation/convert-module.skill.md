...
> **REFERENCE COPY for browsing** — the LIVE skill (what `/convert-module` actually loads) is `.claude/skills/convert-module/SKILL.md`. Edit the live file and re-copy here; never edit this copy alone.
