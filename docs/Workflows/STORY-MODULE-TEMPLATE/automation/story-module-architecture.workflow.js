// REFERENCE COPY for browsing — the LIVE, executable workflow is
// .claude/workflows/story-module-architecture.js (the Workflow tool only reads
// from there). Edit the live file and re-copy here; never edit this copy alone.
