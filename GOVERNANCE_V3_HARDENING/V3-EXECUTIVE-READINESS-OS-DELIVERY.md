...
- Post-review remediation commits on this branch (see “Post-Review Blockers” below): `d2e3faf5` (scoring scale + identity binding), `f602025b` (in-portal reference documents), plus the UI-action/oversight/report commits that follow them.
