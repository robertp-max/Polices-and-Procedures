...
**Output location (requested):** Copy this report (or the version written during execution) into the UAT package folder.
**Related:** See also Agent_Report style for A20 if needed for supervisor side of journey.