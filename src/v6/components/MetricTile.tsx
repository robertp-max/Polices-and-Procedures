...
export function MetricTile({ metric }: MetricTileProps) {
  return (
    <article className={cx(
      'min-h-[106px] min-w-0 rounded-lg border p-lg shadow-rest transition-all duration-base ease-standard hover:translate-y-hover-lift hover:shadow-hover active:scale-press',
