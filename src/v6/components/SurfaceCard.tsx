...
export function SurfaceCard({ card, children, className }: SurfaceCardProps) {
  ...
  return (
    <article className={cx(
      'rounded-lg border border-hairline bg-surface-glass p-lg shadow-rest backdrop-blur-xl transition duration-base ease-standard hover:bg-surface-glass hover:shadow-hover active:scale-press',
      className
    )}>
