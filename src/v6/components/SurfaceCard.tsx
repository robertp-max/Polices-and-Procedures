...
export function SurfaceCard({ card, children, className }: SurfaceCardProps) {
  ...
  return (
    <article className={cx(
      'rounded-lg border border-hairline bg-surface-glass p-lg shadow-glass-inset backdrop-blur-xl transition duration-base ease-standard hover:bg-surface-glass hover:shadow-rest active:scale-press',
      className
    )}>
