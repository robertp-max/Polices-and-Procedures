...
export default function ExecutiveModuleView({ module, onExit }: { module: ExecutiveCaseModule; onExit: () => void }) {
  ...
  const scoreEligible = progress.submitted && clock.minimumMet && scores.total >= MODULE_MASTERY_STANDARD && scores.criticalErrors.length === 0;
