  ...
  return (
    <div className="page page-brief">
      ...
      <section className="brief-stats">
        <article><Target size={20} /><div><strong>{MODULE_MASTERY_STANDARD}%</strong><span>Pass threshold</span></div><p>No critical error may survive.</p></article>
