      ...
      <section className="flex flex-wrap items-start justify-between gap-lg rounded-lg border border-card bg-surface p-lg shadow-rest">
        <div className="grid gap-sm">
          <div className="flex flex-wrap items-center gap-sm">
            <ToneTag>/hubstaff</ToneTag>
            <ToneTag tone="slate">hubstaff</ToneTag>
            <ToneTag tone="slate">reports</ToneTag>
            <ToneTag tone="teal">System</ToneTag>
          </div>
          <div className="grid gap-xs">
            <h2 className="text-h2 font-medium text-ink">Hubstaff Integration Logs</h2>
            <p className="max-w-content text-sm text-secondary">
              GPS and time-tracking logs mapping visit durations, travel mileage, and documentation timeliness.
            </p>
          </div>
        </div>
        <div className="flex flex-wrap items-center gap-sm">
          <ToneBadge size="sm" status="active" />
          <Badge variant="count">HUBSTAFF-API</Badge>
        </div>
      </section>
