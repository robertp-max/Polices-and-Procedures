...
export const V6_ROUTES = [
  ...
  { path: '/governance', hashId: 'governance', template: 'reports', group: 'System', title: 'Governing Body Portal', description: 'Governing Body Office home — executive oversight, decisions, and records.' },
  { path: '/governance/my-work', hashId: 'governance', template: 'reports', group: 'System', title: 'My Governing Body Work', description: 'Authority-filtered assignments, actions, and required learning.' },
  { path: '/governance/meetings', hashId: 'governance', template: 'reports', group: 'System', title: 'Governing Body Meetings', description: 'Meeting preparation, execution, minutes, and close.' },
  ...
  { path: '/governance/board-books', hashId: 'governance', template: 'reports', group: 'System', title: 'Board Books', description: 'Packet Studio artifacts and frozen manifests.' },
  { path: '/governance/decisions', hashId: 'governance', template: 'reports', group: 'System', title: 'Decision Docket', description: 'Decision intake, authority, disposition, and actions.' },
  { path: '/governance/qapi', hashId: 'governance', template: 'reports', group: 'System', title: 'QAPI Oversight', description: 'Source-qualified QAPI oversight.' },
  { path: '/governance/oversight', hashId: 'governance', template: 'reports', group: 'System', title: 'Enterprise Oversight', description: 'Governance oversight domains.' },
  { path: '/governance/risk', hashId: 'governance', template: 'reports', group: 'System', title: 'Enterprise Risk', description: 'Board-level risk posture.' },
  { path: '/governance/records', hashId: 'governance', template: 'evidence', group: 'System', title: 'Governing Body Records', description: 'Access-audited official records projection.' },
  { path: '/governance/calendar', hashId: 'governance', template: 'reports', group: 'System', title: 'Governance Calendar', description: 'Authority-filtered governance calendar.' },
