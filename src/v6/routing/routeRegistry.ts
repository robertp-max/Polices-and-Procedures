...
export const V6_ROUTES = [
  ...
  { path: '/compliance', hashId: 'compliance-home', template: 'dashboard', group: 'CES', title: 'Compliance Home', description: 'Compliance Execution Sprint landing page for sprint status, blockers, evidence gaps, sign-offs, and readiness actions.' },
  ...
  { path: '/workflows/:workflowId', hashId: 'workflow-detail', template: 'detail', group: 'Taxonomy', title: 'Workflow Detail', description: 'Workflow detail page for reference metadata and navigation to swimlane.' },
  { path: '/workflows/:workflowId/swimlane', hashId: 'workflow-swimlane', template: 'board', group: 'Taxonomy', title: 'Workflow Swimlane', description: 'Workflow swimlane for intake, evidence, review, signature, and lock steps (reference or event execution context).' },
  ...
  { path: '/compliance/master-controls', hashId: 'master-controls', template: 'matrix', group: 'CES', title: 'Control Register', description: 'Compliance control register mapped to risk, evidence, readiness, and owner action.' },
  ...
  { path: '/evidence', hashId: 'defensible-2', template: 'evidence', group: 'CES', title: 'Compliance Workspace', description: 'Compliance workspace for Drive evidence, packet creation, packet edits, and eCign tracking.' },
  ...
  { path: '/journey/gao-001-v1-1', hashId: 'gao-001-v11-preview', template: 'journey', group: 'Onboarding', title: 'GAO-001: A New Journey', description: 'GAO-001 interactive learner module.' },
