...
export const PAGE_REGISTRY: PageRegistryEntry[] = [
  ...
  {
    pageId: 'page.taxonomy',
    label: 'Taxonomy',
    routePattern: '/taxonomy',
    componentGroup: 'cmp-policy-library',
    defaultAccess: 'read',
  },
  {
  ...
  {
    pageId: 'page.ces-workloads',
    label: 'CES Workloads',
    routePattern: '/ces/workloads',
    componentGroup: 'cmp-ces',
    defaultAccess: 'read',
  },
  {
  ...
  {
    pageId: 'page.pm-tasks',
    label: 'PM — My Tasks',
    routePattern: '/pm/my-tasks',
    componentGroup: 'cmp-ces',
    defaultAccess: 'read',
  },
  {
    pageId: 'page.pm-sprint-plan',
    label: 'PM — Sprint Plan',
    routePattern: '/pm/sprint-plan',
    componentGroup: 'cmp-ces',
    defaultAccess: 'read',
  },
  {
    pageId: 'page.pm-sprint-review',
    label: 'PM — Sprint Review',
    routePattern: '/pm/sprint-review',
    componentGroup: 'cmp-ces',
    defaultAccess: 'read',
  },
  {
    pageId: 'page.pm-approvals',
    label: 'PM — Approvals',
    routePattern: '/pm/approvals',
    componentGroup: 'cmp-ces',
    defaultAccess: 'read',
  },
  {
    pageId: 'page.pm-dashboard',
    label: 'PM — Dashboard',
    routePattern: '/pm/dashboard',
    componentGroup: 'cmp-ces',
    defaultAccess: 'read',
  },
  ...
  {
    pageId: 'page.onboarding-v2',
    label: 'Onboarding v2',
    routePattern: '/onboarding-v2',
    componentGroup: 'cmp-journey',
    defaultAccess: 'read',
  },
