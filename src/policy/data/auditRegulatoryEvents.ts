...
const AUDIT_SPECS: AuditSpec[] = [
  // ── Clinical (10 — monthly) ───────────────────────────────────
  {
    ...
    policyRefs: ['CL-CP-005', 'CL-CP-007'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    owner: 'QA Reviewer (RN)', ownerRole: 'QA Reviewer',
    policyRefs: ['CL-CP-004'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    owner: 'QA Reviewer (RN)', ownerRole: 'QA Reviewer',
    policyRefs: ['CL-CP-008'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    policyRefs: ['CL-CD-001'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    policyRefs: ['CL-CP-002', 'CL-CP-005'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    owner: 'QA Reviewer (RN)', ownerRole: 'QA Reviewer',
    policyRefs: ['CL-SD-013'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    policyRefs: ['CL-SD-016'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    owner: 'Clinical Manager', ownerRole: 'Clinical Manager',
    policyRefs: ['CL-CP-007'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    owner: 'Clinical Manager', ownerRole: 'Clinical Manager',
    policyRefs: ['CL-CP-005'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    owner: 'QA Reviewer (RN)', ownerRole: 'QA Reviewer',
    policyRefs: ['CL-CP-005', 'CL-CP-006'], mandateType: 'federal-required',
  ...
  // ── Compliance (5) ───────────────────────────────────────────
  {
    ...
    policyRefs: ['CO-CP-001', 'CO-CP-002'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    policyRefs: ['CO-CP-005'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    policyRefs: ['FN-BC-002'], mandateType: 'federal-required',
  ...
  },
  {
    ...
    policyRefs: ['CO-CP-007'], mandateType: 'federal-required',
