...
export function SupervisorPage() {
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar p-6 md:p-10">
      <div className="mb-6">
        <div className="text-xs font-montserrat font-bold text-[#FFC107] uppercase tracking-widest mb-2">Supervisor / DON View</div>
        <h1 className="text-2xl font-montserrat font-bold text-white">Team Onboarding &amp; Competency</h1>
        <div className="text-sm text-white/55 font-light mt-1">HR-TA-005 §6.1 · HR-TD-003 · HR-TD-001 §4.6</div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        {/* Roster */}
        <div className="col-span-12 lg:col-span-5 border border-white/10 rounded-2xl overflow-hidden">
          <div className="px-4 py-3 border-b border-white/10 flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-white/60">
        ...
        <div className="col-span-12 lg:col-span-7 space-y-4">
          ...
          {selectedEscalations.length > 0 && (
            <div className="border border-[#DC2626]/30 rounded-2xl p-5">
