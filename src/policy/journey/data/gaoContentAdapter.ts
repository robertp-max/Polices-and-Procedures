...
function sanitizeLearnerText(text: string): string {
  return stripMarkdown(text)
    ...
    .replace(/\[REGULATORY FIX APPLIED\]\s*/gi, "")
    .replace(/\s*>?\s*PP SEPARATION NOTICE:[^\n]*/gi, "")
    .replace(/Training Module Complete\s*[—-]\s*Scenario Practice Complete/gi, "Scenario Practice Complete")
    .replace(/Completion of this module is a Training Module Complete event\.?/gi, "")
    .replace(/\|[^\n]*\|/g, "")
