...
const GAO: JourneyModule[] = [
  ...
  { id: 'GAO-014', group: 'GAO', phase: 'GAO', title: 'Bloodborne pathogen exposure control', roles: 'ALL', policyRefs: ['RM-OS-001'], cmsRefs: ['OSHA 29 CFR 1910.1030'], method: 'Quiz', passThreshold: 0.8 },
...
const DON: JourneyModule[] = [
  { id: 'DON-001', group: 'ROLE', phase: 'ROLE', week: 1, title: 'Clinical Manager CMS CoP requirements', roles: ['DON'], policyRefs: ['EN-CM-001', 'HR-TA-005'], cmsRefs: ['42 CFR 484.105(c)', '42 CFR 484.115'], method: 'Quiz', passThreshold: 0.8 },
  { id: 'DON-002', group: 'ROLE', phase: 'ROLE', week: 1, title: 'Clinical supervision framework — RN, LVN, PT, OT, SLP, MSW, HHA', roles: ['DON'], policyRefs: ['HR-TA-005'], cmsRefs: ['42 CFR 484.115'], method: 'Scenario' },
  { id: 'DON-003', group: 'ROLE', phase: 'ROLE', week: 1, title: 'HHA supervision requirements — 14-day/60-day cycle', roles: ['DON'], policyRefs: ['HR-TD-003'], cmsRefs: ['42 CFR 484.80(h)'], method: 'Quiz', passThreshold: 0.8 },
  ...
  { id: 'DON-013', group: 'ROLE', phase: 'ROLE', week: 4, title: 'Referral & intake — clinical screening', roles: ['DON'], policyRefs: ['OP-IM-001'], cmsRefs: [], method: 'Observation' },
