 ...
 */
const CACHE_BUST = 'v=20260709-1315';
...
export const gao001SceneArt = {
  ...
  "scene-02": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-02.png",
    legacySrc: "",
    alt: "Alex reviews the agency mission and vision statements.",
  },
  "scene-03": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-03.png",
    legacySrc: "",
    alt: "Visual representation of the core values in action.",
  },
  "scene-04": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-04.png",
    legacySrc: "",
    alt: "Scene illustrating what makes home health different from facility care.",
  },
  "scene-05": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-05.png",
    legacySrc: "",
    alt: "A view of the reporting protocol steps.",
  },
  "scene-06": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-06.png",
    legacySrc: "",
    alt: "Illustration of patient rights and respectful refusal.",
  },
  "scene-07": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-07.png",
    legacySrc: "",
    alt: "Practice scenario for the escalation pathway.",
  },
  "scene-08": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-08.png",
    legacySrc: "",
    alt: "Survey readiness checklist and expectations.",
  },
  "scene-09": {
    src: "/training/gao-001/scene-art/v2/gao-001-scene-09.png",
    legacySrc: "",
