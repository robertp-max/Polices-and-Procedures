...
const IMG = {
  M09: '/assets/media/hipaa-privacy.jpg',
  M10: '/assets/media/patient-rights.jpg',
  M11: '/assets/media/infection-ppe.jpg',
  M12: '/assets/media/abuse-reporting.jpg',
};
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l0/objectives.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l1/content1.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l1/takeaways.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
        card_id: 'achc_m09_l1_c2', type: 'content', title: 'Field Scenario: Colleague Rounding Up Visit Times',
        content: 'Field scenario: A senior clinician tells you: "Just add 15 minutes to every visit note for charting time. Medicare pays per visit anyway and everyone does it. The agency looks more efficient." You know documentation must reflect actual time spent.\n\nPer CO-CP-001 (Corporate Compliance Program):\n• Document ACTUAL time in and time out\n• "Everyone does it" is not a defense — it is evidence of systemic false claims risk\n• Report the pattern to Compliance Officer (not just supervisor if leadership involved)\n• Accurate documentation protects you individually\n\nFalsifying time = False Claims Act exposure.',
        narration_script: 'Field scenario on rounding time. A colleague advises adding 15 min to notes. Per CO-CP-001 (Corporate Compliance Program), document actual time only. "Everyone does it" creates false claims liability. Report patterns accurately through proper channels. Accurate records protect the individual clinician.',
        audio_path: '/training-audio/ACHC-ART-M09/l1/content2.wav', image_url: IMG.M09, estimated_duration: '1:15', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l1/debrief.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l2/content1.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l3/takeaways.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l3/debrief.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l4/finaldebrief.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l4/nextsteps.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M09/l4/survey.wav', image_url: IMG.M09, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l0/objectives.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l1/content1.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l1/takeaways.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l1/debrief.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l2/takeaways.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l3/takeaways.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l3/debrief.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
    ...
    cards: [
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l4/synthesis.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l4/finaldebrief.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M10/l4/survey.wav', image_url: IMG.M10, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l0/objectives.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
      {
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l1/takeaways.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l1/debrief.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l2/takeaways.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l2/debrief.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l3/debrief.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
    ...
    cards: [
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l4/synthesis.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l4/finaldebrief.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M11/l4/survey.wav', image_url: IMG.M11, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M12/l0/objectives.wav', image_url: IMG.M12, estimated_duration: '1:10', completion_required: true,
      },
      {
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M12/l1/takeaways.wav', image_url: IMG.M12, estimated_duration: '1:10', completion_required: true,
      },
      {
        card_id: 'achc_m12_l1_c2', type: 'content', title: 'Field Scenario: Near-Miss Glucose Meter Systematic Error',
        content: 'Field scenario: Over three visits, a patient\'s home glucose meter consistently reads 35 mg/dL lower than lab draw same day. Patient adjusted insulin, had one hypoglycemic episode requiring juice. No ER. Device is new.\n\nPer RM-MD-001 (Medical Device Reporting):\n• This meets "may have contributed to" serious injury threshold (hypoglycemia intervention)\n• Report to Administrator immediately for MDR filing\n• Preserve meter; do not return to DME\n• Document readings vs lab, patient actions, outcome\n• Voluntary MedWatch also encouraged for near misses\n\nReport even if patient "fine now".',
        narration_script: 'Field scenario: systematic glucose meter error leading to hypo episode. Per RM-MD-001 (Medical Device Reporting), "may have contributed" triggers report. Preserve device, document discrepancy, escalate to Administrator for FDA timeline. Even recovered patients require reporting for pattern detection.',
        audio_path: '/training-audio/ACHC-ART-M12/l1/content2.wav', image_url: IMG.M12, estimated_duration: '1:15', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M12/l1/debrief.wav', image_url: IMG.M12, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
...

  {
    ...
    cards: [
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M12/l3/takeaways.wav', image_url: IMG.M12, estimated_duration: '1:10', completion_required: true,
      },
      {
      ...
      },
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M12/l3/debrief.wav', image_url: IMG.M12, estimated_duration: '1:10', completion_required: true,
      },
    ],
  },
    ...
    cards: [
      {
        ...
        audio_path: '/training-audio/ACHC-ART-M12/l4/synthesis.wav', image_url: IMG.M12, estimated_duration: '1:10', completion_required: true,
      },
      {
