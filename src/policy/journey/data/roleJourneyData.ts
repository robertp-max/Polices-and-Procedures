...
const DON_MODULES: RoleModuleRow[] = [
  { id: 'DON-001', phase: 'Week 1', title: 'DON Role, Authority & Regulatory Mandate', policy: '§ 484.105(c), § 484.115', method: 'Classroom', competency: 'Quiz (80%)', competencyKind: 'quiz' },
  { id: 'DON-002', phase: 'Week 1', title: 'California Home Health Licensing & Conditions of Participation', policy: 'All § 484.115 subsections', method: 'Classroom', competency: 'Scenario', competencyKind: 'scenario' },
  { id: 'DON-003', phase: 'Week 1', title: 'Clinical Supervision Framework', policy: '§ 484.80(h)', method: 'Classroom + forms review', competency: 'Quiz', competencyKind: 'quiz' },
  { id: 'DON-004', phase: 'Week 1', title: 'OASIS Oversight & Accuracy Program', policy: 'CL-CP-001 through CL-CP-009', method: 'Case study + record review', competency: 'Record audit exercise', competencyKind: 'exercise' },
  { id: 'DON-005', phase: 'Week 2', title: 'Plan of Care Management', policy: 'CL-OA series, CL-OA-006', method: 'Classroom + coding exercise', competency: 'Coding assessment (80%)', competencyKind: 'exercise' },
  { id: 'DON-006', phase: 'Week 2', title: 'QAPI Program Leadership', policy: 'CL-CD-001 through CL-CD-004', method: 'Record review exercise', competency: 'Documentation audit', competencyKind: 'exercise' },
  { id: 'DON-007', phase: 'Week 2', title: 'Infection Prevention Program Oversight', policy: 'CL-OA-006', method: 'Classroom', competency: 'Case study', competencyKind: 'case-study' },
  { id: 'DON-008', phase: 'Week 2', title: 'Emergency Preparedness — Clinical Operations Leadership', policy: 'HR-TD-003', method: 'Classroom + tool review', competency: 'Appendix A completion exercise', competencyKind: 'exercise' },
  { id: 'DON-009', phase: 'Week 3', title: 'Patient Assessment Oversight', policy: 'QA-PG-001, QA-PI series', method: 'Classroom + data review', competency: 'Data analysis exercise', competencyKind: 'exercise' },
  { id: 'DON-010', phase: 'Week 3', title: 'Clinical Documentation Standards & Audit', policy: 'CL-SD-016, § 484.70', method: 'Classroom', competency: '—', competencyKind: 'none' },
