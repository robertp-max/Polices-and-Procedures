...
function makeOwner(key: string): Owner {
  const p = V3_Personas[key] || V3_Personas['u-don-01'];
  if (!p) {
    // Ultimate fallback (should never happen) — protects against typos in large generated seed data
    return { userId: 'u-don-01', name: 'Maria Gonzalez, RN', initials: 'MG', role: 'DON' };
  }
...
export const V3_ExecutionUnitsSeed: ExecutionUnit[] = [
  ...
  // ────────────────────────────────────────────────────────────────────────
  // EXTENDED FULL-YEAR CES EVENTS (realistic from regulatory/QAPI/governance
  // patterns; all Tue/Thu, <=4 per day across year). Added for V2 CES calendar
  // to use right data source coverage (Jan-Dec 2026). No synthetic reassignment.
  // ────────────────────────────────────────────────────────────────────────
  {
    id: 'ceu-qapi-jan-001',
    title: 'Q1 QAPI data review & indicator compilation',
    parentEventId: 'evt-qapi-q1-2026',
    workflowId: 'QA-WF-03',
    workflowPhase: 'review',
    complianceState: 'ready',
    auditReadiness: 'ready',
    ...
    signatureOwner: makeOwner('u-don-01'),
    requiredSigners: makeSigners([
      { userId: 'u-don-01', name: 'Maria Gonzalez, RN', initials: 'MG', role: 'DON', status: 'signed', signedAt: '2026-01-13T10:00:00Z' },
    ]),
    dueDate: '2026-01-13',  // Tuesday (Tue/Thu schedule)
    escalationTimer: 10,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 3,
      requiredFormsComplete: 3,
  ...
  {
    id: 'ceu-gb-feb-001',
    title: 'Q1 Governing Body pre-read packet prep',
    parentEventId: 'evt-gb-q1-2026',
    workflowId: 'GV-WF-01',
    workflowPhase: 'signature',
    complianceState: 'in_progress',
    auditReadiness: 'partial',
    ...
    signatureOwner: makeOwner('u-gb-01'),
    requiredSigners: makeSigners([
      { userId: 'u-gb-01', name: 'Patricia Hale', initials: 'PH', role: 'Governing Body', status: 'pending', hoursToEscalation: 50 },
    ]),
    dueDate: '2026-02-12',  // Thursday (Tue/Thu schedule)
    escalationTimer: 50,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 2,
      requiredFormsComplete: 1,
  ...
  {
    id: 'ceu-ipc-mar-001',
    title: 'Q1 Infection Prevention — TB/annual screening audit',
    parentEventId: 'evt-ipc-q1-2026',
    workflowId: 'CL-WF-32',
    workflowPhase: 'documentation',
    complianceState: 'awaiting_signature',
    auditReadiness: 'not_ready',
    ...
    signatureOwner: makeOwner('u-don-01'),
    requiredSigners: makeSigners([
      { userId: 'u-don-01', name: 'Maria Gonzalez, RN', initials: 'MG', role: 'DON', status: 'pending', hoursToEscalation: 22 },
    ]),
    dueDate: '2026-03-05',  // Thursday (Tue/Thu schedule)
    escalationTimer: 22,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 2,
      requiredFormsComplete: 1,
      missingFormIds: ['IP-FM-003'],
      signaturesRequired: 1,
      signaturesComplete: 0,
    }),
    domain: 'clinical',
    ...
    sourceType: 'WORKFLOW',
    sprintId: '2026-03',
    assignedRole: 'Clinical Manager',
    accountableRole: 'DON',
    reviewerRole: 'Administrator',
    approverRole: 'DON',
    canCompleteRoles: ['Clinical Manager'],
    canReviewRoles: ['DON'],
    canApproveRoles: ['DON'],
    escalationRole: 'DON',
  },
  {
    id: 'ceu-qapi-jul-001',
    title: 'Q3 QAPI indicator data compilation',
    parentEventId: 'evt-qapi-q3-2026',
    workflowId: 'QA-WF-03',
    workflowPhase: 'review',
    complianceState: 'in_progress',
    auditReadiness: 'partial',
    ...
    dueDate: '2026-07-07',  // Tuesday (Tue/Thu schedule)
    escalationTimer: 40,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 4,
      requiredFormsComplete: 2,
  ...
  {
    id: 'ceu-gb-aug-001',
    title: 'Q3 Governing Body packet & financial oversight review',
    parentEventId: 'evt-gb-q3-2026',
    workflowId: 'GV-WF-01',
    workflowPhase: 'signature',
    complianceState: 'ready',
    auditReadiness: 'ready',
    ...
    signatureOwner: makeOwner('u-gb-01'),
    requiredSigners: makeSigners([
      { userId: 'u-gb-01', name: 'Patricia Hale', initials: 'PH', role: 'Governing Body', status: 'pending', hoursToEscalation: 18 },
      { userId: 'u-admin-01', name: 'Robert Chen', initials: 'RC', role: 'Administrator', status: 'signed', signedAt: '2026-08-05T14:00:00Z' },
    ]),
    dueDate: '2026-08-06',  // Thursday (Tue/Thu schedule)
    escalationTimer: 18,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 3,
      requiredFormsComplete: 3,
  ...
  {
    id: 'ceu-hr-sep-001',
    title: 'Q3 personnel file & competency audit closeout',
    parentEventId: 'evt-hr-q3-2026',
    workflowId: 'HR-WF-04',
    workflowPhase: 'documentation',
    complianceState: 'blocked',
    auditReadiness: 'not_ready',
    ...
    dueDate: '2026-09-10',  // Thursday (Tue/Thu schedule)
    escalationTimer: 60,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 5,
      requiredFormsComplete: 3,
      missingFormIds: ['HR-FM-005'],
      signaturesRequired: 1,
      signaturesComplete: 0,
    }),
    domain: 'hr',
  ...
  {
    id: 'ceu-qapi-oct-001',
    title: 'Q4 QAPI data aggregation & CAPA rollup',
    parentEventId: 'evt-qapi-q4-2026',
    workflowId: 'QA-WF-03',
    workflowPhase: 'review',
    complianceState: 'in_progress',
    auditReadiness: 'partial',
    ...
    signatureOwner: makeOwner('u-don-01'),
    requiredSigners: makeSigners([
      { userId: 'u-don-01', name: 'Maria Gonzalez, RN', initials: 'MG', role: 'DON', status: 'pending', hoursToEscalation: 25 },
    ]),
    dueDate: '2026-10-08',  // Thursday (Tue/Thu schedule)
    escalationTimer: 25,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 4,
      requiredFormsComplete: 2,
  ...
  {
    id: 'ceu-gb-nov-001',
    title: 'Annual Governing Body compliance attestation packet',
    parentEventId: 'evt-gb-q4-2026',
    workflowId: 'GV-WF-01',
    workflowPhase: 'signature',
    complianceState: 'awaiting_signature',
    auditReadiness: 'partial',
    ...
    signatureOwner: makeOwner('u-gb-01'),
    requiredSigners: makeSigners([
      { userId: 'u-gb-01', name: 'Patricia Hale', initials: 'PH', role: 'Governing Body', status: 'pending', hoursToEscalation: 35 },
    ]),
    dueDate: '2026-11-10',  // Tuesday (Tue/Thu schedule)
    escalationTimer: 35,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 2,
      requiredFormsComplete: 1,
    ...
    obligationKind: 'REGULATORY',
    sourceType: 'REGULATORY_EVENT',
    sourcePolicyIds: ['GV-GB-001', 'CO-CP-001'],
    sprintId: '2026-11',
    assignedRole: 'DON',
    accountableRole: 'Governing Body',
    reviewerRole: 'Administrator',
  ...
  {
    id: 'ceu-comp-dec-001',
    title: 'Annual compliance program attestation & OIG review',
    parentEventId: 'evt-comp-ann-2026',
    workflowId: 'CO-WF-01',
    workflowPhase: 'documentation',
    complianceState: 'ready',
    auditReadiness: 'ready',
    ...
    signatureOwner: makeOwner('u-admin-01'),
    requiredSigners: makeSigners([
      { userId: 'u-admin-01', name: 'Robert Chen', initials: 'RC', role: 'Administrator', status: 'pending', hoursToEscalation: 14 },
    ]),
    dueDate: '2026-12-08',  // Tuesday (Tue/Thu schedule)
    escalationTimer: 14,
    evidenceStatus: makeEvidenceStatus({
      requiredFormsTotal: 5,
      requiredFormsComplete: 5,
...
// Dev-only guard: catch bad persona keys or missing owners at module load time
// (prevents opaque "Cannot read ... of undefined" crashes in screens that import the seed).
if (typeof import.meta !== 'undefined' && import.meta.env?.DEV) {
  const badOwners = V3_ExecutionUnitsSeed.filter(u => !u.owner || !u.owner.userId || !u.owner.name);
  if (badOwners.length > 0) {
    console.error('[V3_CES_SeedData] Units with invalid/missing owner:', badOwners.map(u => u.id));
  }
}
