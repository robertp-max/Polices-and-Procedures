...
export const V3_POLICIES: V3Policy[] = [
  { id: 'CL-IPC-001', title: 'Infection Prevention & Control Program', domain: 'Clinical', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Maria Gonzalez, RN', lastReviewed: '2026-04-15', nextReview: '2027-04-15', version: '4.2' },
  { id: 'CL-IPC-003', title: 'TB Screening & Documentation', domain: 'Clinical', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Maria Gonzalez, RN', lastReviewed: '2026-03-01', nextReview: '2027-03-01', version: '3.0' },
  ...
  { id: 'QA-QAPI-001', title: 'QAPI Program Framework', domain: 'QAPI', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Nicole Foster', lastReviewed: '2026-04-01', nextReview: '2027-04-01', version: '3.1' },
  { id: 'QA-DATA-003', title: 'Quality Data Collection & Reporting', domain: 'QAPI', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Nicole Foster', lastReviewed: '2026-03-15', nextReview: '2027-03-15', version: '2.0' },
  ...
  { id: 'HR-PF-001', title: 'Personnel File Requirements', domain: 'HR', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Robert Chen', lastReviewed: '2026-02-15', nextReview: '2027-02-15', version: '4.0' },
  { id: 'HR-COMP-001', title: 'Staff Competency Assessment Program', domain: 'HR', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Maria Gonzalez, RN', lastReviewed: '2026-04-05', nextReview: '2027-04-05', version: '2.1' },
  ...
  { id: 'CL-WC-001', title: 'Wound Care Assessment Protocol', domain: 'Clinical', lifecycle: 'Review', achcMapping: 'Mapped', owner: 'Priya Sharma', lastReviewed: '2026-05-19', nextReview: '2026-11-19', version: '3.0' },
  { id: 'CL-MR-001', title: 'Medication Reconciliation Procedures', domain: 'Clinical', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Maria Gonzalez, RN', lastReviewed: '2026-05-15', nextReview: '2027-05-15', version: '2.4' },
  ...
  { id: 'GV-POL-001', title: 'Policy & Procedure Management', domain: 'Governance', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Robert Chen', lastReviewed: '2026-04-28', nextReview: '2027-04-28', version: '4.0' },
  ...
  { id: 'CL-SV-001', title: 'Supervisory Visit Requirements', domain: 'Clinical', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Maria Gonzalez, RN', lastReviewed: '2026-05-20', nextReview: '2027-05-20', version: '2.1' },
  { id: 'FIN-OV-001', title: 'Revenue Cycle Management', domain: 'Finance', lifecycle: 'Published', achcMapping: 'N/A', owner: 'David Kim, CPA', lastReviewed: '2026-04-10', nextReview: '2027-04-10', version: '1.3' },
  ...
  { id: 'HR-BG-001', title: 'Background Check & Exclusion Screening', domain: 'HR', lifecycle: 'Draft', achcMapping: 'Pending', owner: 'James Torres', lastReviewed: '2026-05-10', nextReview: '2026-08-10', version: '1.0' },
  ...
  { id: 'GV-COI-001', title: 'Conflict of Interest Disclosure', domain: 'Governance', lifecycle: 'Pending Approval', achcMapping: 'In Progress', owner: 'Patricia Hale', lastReviewed: '2026-05-18', nextReview: '2027-05-18', version: '2.0' },
  { id: 'CL-ABN-001', title: 'Abuse & Neglect Reporting', domain: 'Clinical', lifecycle: 'Published', achcMapping: 'Mapped', owner: 'Robert Chen', lastReviewed: '2026-04-17', nextReview: '2027-04-17', version: '4.1' },
];
...
export const V3_FORMS: V3Form[] = [
  ...
  { id: 'FRM-HR-001', title: 'Personnel File Audit Checklist', domain: 'HR', status: 'Active', lastUpdated: '2026-05-08', completionRate: 100, requiredBy: 'HR-PF-001' },
  ...
  { id: 'FRM-COMP-001', title: 'Clinical Competency Evaluation Tool', domain: 'HR', status: 'Active', lastUpdated: '2026-05-19', completionRate: 55, requiredBy: 'HR-COMP-001' },
  { id: 'FRM-COMP-002', title: 'Supervisory Observation Checklist', domain: 'HR', status: 'Active', lastUpdated: '2026-05-14', completionRate: 30, requiredBy: 'HR-COMP-001' },
  { id: 'FRM-ORI-007', title: 'New Hire Orientation Checklist', domain: 'HR', status: 'Active', lastUpdated: '2026-05-20', completionRate: 67, requiredBy: 'HR-PF-001' },
  { id: 'FRM-POL-001', title: 'Policy Review Tracking Matrix', domain: 'Governance', status: 'Active', lastUpdated: '2026-05-18', completionRate: 80, requiredBy: 'GV-POL-001' },
  { id: 'FRM-FIN-001', title: 'Quarterly Financial Summary Report', domain: 'Finance', status: 'Active', lastUpdated: '2026-05-15', completionRate: 50, requiredBy: 'FIN-OV-001' },
  ...
  { id: 'FRM-ABN-008', title: 'Abuse/Neglect Reporting Attestation', domain: 'Clinical', status: 'Active', lastUpdated: '2026-05-17', completionRate: 70, requiredBy: 'CL-ABN-001' },
  ...
  { id: 'FRM-INF-001', title: 'Monthly Infection Surveillance Log', domain: 'Clinical', status: 'Active', lastUpdated: '2026-05-10', completionRate: 33, requiredBy: 'CL-IPC-001' },
  { id: 'FRM-COI-001', title: 'Conflict of Interest Disclosure Form', domain: 'Governance', status: 'Draft', lastUpdated: '2026-05-18', completionRate: 0, requiredBy: 'GV-COI-001' },
];
