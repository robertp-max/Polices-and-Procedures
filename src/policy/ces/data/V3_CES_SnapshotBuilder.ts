...
const V3_REGULATORY_EVENTS: RegulatoryEvent[] = [
  ...
  },
  {
    ...
    cadence: 'Quarterly',
    urgency: 'critical',
    policyRefs: ['QA-QAPI-001', 'QA-DATA-003'],
  ...
  },
  {
    ...
    cadence: 'Annual',
    urgency: 'overdue',
    policyRefs: ['CL-IPC-001', 'CL-IPC-003'],
    owner: 'James Torres',
  ...
  },
  {
    ...
    cadence: 'Annual',
    urgency: 'due-soon',
    policyRefs: ['IT-HIPAA-001', 'IT-HIPAA-003', 'HR-TRAIN-002'],
    owner: 'Elena Vargas',
    ownerRole: 'Systems',
  ...
  },
  {
    ...
    policyRefs: ['EP-002', 'EP-005', 'OP-SAFETY-001'],
    owner: 'James Torres',
    ownerRole: 'Admin Designee',
  ...
  },
  {
    ...
    cadence: 'Annual',
    urgency: 'on-track',
    policyRefs: ['GV-POL-001', 'GV-POL-002', 'GV-GB-003'],
    owner: 'Patricia Hale',
    ownerRole: 'Governing Body',
  ...
  },
  {
    ...
    cadence: 'Monthly',
    urgency: 'scheduled',
    policyRefs: ['CL-IPC-001', 'CL-IPC-005', 'QA-DATA-003'],
    owner: 'Maria Gonzalez, RN',
    ownerRole: 'DON',
  ...
  },
  {
    ...
    cadence: 'Quarterly',
    urgency: 'overdue',
    policyRefs: ['HR-COMP-001', 'CL-COMP-002', 'HR-PF-001'],
    owner: 'Maria Gonzalez, RN',
    ownerRole: 'DON',
  ...
  },
  {
    ...
    cadence: 'Quarterly',
    urgency: 'blocked',
    policyRefs: ['FIN-OV-001', 'GV-GB-002', 'FIN-AUD-001'],
    owner: 'David Kim, CPA',
    ownerRole: 'Accounting',
  ...
  },
  {
    ...
    cadence: 'Monthly',
    urgency: 'on-track',
    policyRefs: ['CL-OAS-001', 'QA-DATA-002'],
    owner: 'Maria Gonzalez, RN',
    ownerRole: 'DON',
  ...
  },
  {
    ...
    cadence: 'Quarterly',
    urgency: 'on-track',
    policyRefs: ['QA-HHCAHPS-001', 'QA-DATA-004'],
    owner: 'Patricia Hale',
    ownerRole: 'Governing Body',
  ...
  },
  {
    ...
    cadence: 'Monthly',
    urgency: 'due-soon',
    policyRefs: ['FIN-CLAIMS-001', 'FIN-AUD-002'],
    owner: 'David Kim, CPA',
    ownerRole: 'Accounting',
  ...
  },
  {
    ...
    cadence: 'Monthly',
    urgency: 'scheduled',
    policyRefs: ['CL-MED-001', 'CL-IPC-002'],
    owner: 'James Torres',
    ownerRole: 'Admin Designee',
  ...
  },
  {
    ...
    cadence: 'Annual',
    urgency: 'scheduled',
    policyRefs: ['OP-ACCR-001', 'GV-POL-001'],
    owner: 'Robert Chen',
