  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        <span className="text-[10.5px] font-montserrat font-bold ci-text-subtle uppercase tracking-[0.14em]">
        ...
        {!locked && (
          <div className="flex gap-1.5">
            <button
              ...
              className="flex items-center gap-1 rounded-md border ci-border px-2 py-1 text-[10px] font-montserrat font-bold ci-text-muted uppercase tracking-[0.12em]"
            >
  ...
  return (
    <li className="flex items-center gap-2.5 p-2 rounded-md border ci-border transition-colors" style={{ background: 'var(--ci-surface-2)' }}>
      ...
      <div className="flex-1 min-w-0">
        <p className="font-montserrat font-bold ci-text text-[11.5px] truncate">{doc.name}</p>
        <p className="text-[10px] font-roboto ci-text-subtle truncate">
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          ...
          aria-label="Download"
          className="w-6 h-6 rounded-md border ci-border flex items-center justify-center ci-text-subtle"
        >
          <Download size={10} />
        </button>
        {!eventLocked && (
          <button
            ...
            aria-label="Remove"
            className="w-6 h-6 rounded-md border ci-border flex items-center justify-center"
      ...
      <div className="p-5 space-y-3">
        ...
        <Field label="Note (optional)">
          <textarea
            ...
            rows={2}
            className="w-full rounded-md px-2.5 py-1.5 text-[12px] font-roboto resize-none"
            style={{
