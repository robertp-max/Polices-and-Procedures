...
const PACKAGES: LegalPackage[] = [
  ...
  },
  {
    ...
    matter: 'Episode close · patient education',
    ...
    hashVerifiedAt: 'Jul 22 · 9:20 AM',
    retention: 'Medical record · 7 years (proposed CA HHA)',
    wormClass: 'WORM-proposed · sealed immutable',
    assembledAt: 'Jul 22 · 9:05 AM',
    assembledBy: 'Taylor Brooks, RN',
    completeness: 100,
    items: [
    ...
    signatures: [
      { role: 'Discharging clinician', name: 'Taylor Brooks, RN', state: 'signed', at: 'Jul 22 · 9:05 AM' },
      { role: 'Patient / representative', name: 'Harold Nguyen (or representative)', state: 'signed', at: 'Jul 22 · 9:12 AM' },
      { role: 'Package seal', name: 'System seal', state: 'signed', at: 'Jul 22 · 9:15 AM' },
    ],
    policyVersions: [
      { label: 'Discharge education policy', version: 'POL-DC-v2.4' },
    ],
    custody: [
      { id: 'c1', at: 'Jul 22 · 9:05 AM', actor: 'Taylor Brooks, RN', action: 'Assembled', detail: 'Pinned teaching, ack, med list.' },
      { id: 'c2', at: 'Jul 22 · 9:15 AM', actor: 'System seal', action: 'Sealed', detail: 'Manifest hash locked; amendments require new package.' },
    ],
    exports: [
