...
const SHARED_STYLES = `
  ...
  .font-roboto { font-family: var(--font-roboto), 'Roboto', sans-serif; }
...
export default function GAO001SharedOverlay({
  ...
  const allComplete = hotspots.length > 0 && completedNodeIds.size === hotspots.length;
  ...
  useEffect(() => {
    if (allComplete && !completionAnnouncedRef.current) {
  ...
  useEffect(() => {
    if (!activeModalNodeId || !modalRef.current) return;
  ...
  return (
    <div className="relative flex h-full min-h-0 w-full flex-col overflow-hidden bg-white font-sans">
      ...
      <div
        className="relative flex min-h-0 w-full flex-1 animate-scene items-center justify-center overflow-hidden"
      ...
      >
        ...
        {activeHotspot && (customModal ?? (
            <div
              ...
              role="dialog"
              aria-modal="true"
              aria-label={activeHotspot.fieldNotes.title}
              tabIndex={-1}
              className={`fixed inset-0 bg-[#1F1C1B]/50 backdrop-blur-md transition-opacity duration-700 flex items-center justify-center p-4 md:p-6 z-50 opacity-100`}
            >
                ...
                {showSuccessScreen ? (
                    <div className="w-full max-w-2xl bg-white rounded-[32px] shadow-[0_32px_80px_rgba(0,0,0,0.2)] border border-[#E5E4E3] py-20 flex flex-col items-center justify-center animate-modal-spring">
                        ...
                        <h2 className="text-2xl font-montserrat font-bold text-[#007970] mb-3">Practice point completed in this preview</h2>
                        <p className="mb-8 px-6 text-center font-roboto text-sm text-[#52404B]">No official completion or score was recorded.</p>
                        <button
                    ...
                    <div className="w-full max-w-7xl flex flex-col lg:flex-row gap-6 relative px-4 md:px-8 max-h-[100dvh] my-auto">
                        ...
                        <button
                            onClick={closeDrawer}
                            aria-label="Close practice point"
          ...
          <div className="absolute inset-0 bg-[#0F5B54]/80 backdrop-blur-md z-30 flex items-center justify-center animate-scene p-8 pointer-events-none">
             <div className="bg-white p-10 rounded-[32px] shadow-2xl border border-[#EEF4F3] text-center max-w-md flex flex-col items-center pointer-events-auto">
                ...
                <p className="text-[#52404B] font-roboto text-base leading-relaxed mb-8">
                  Practice interactions are complete in this preview. No official completion was recorded.
                </p>
