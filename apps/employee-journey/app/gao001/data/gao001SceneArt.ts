 ...
 */
const CACHE_BUST = 'v=20260723-local';

export const gao001SceneArt = {
  "scene-01": {
    /** Interactive Welcome Desk background */
    src: `/training/gao-001/scene-art/v2/scene-01/gao-001-scene-01-desk.webp?${CACHE_BUST}`,
    legacySrc: "",
     ...
     */
    cover: [
      `/training/gao-001/scene-art/v2/scene-01/gao-001-scene-01-cover-a.webp?${CACHE_BUST}`,
      `/training/gao-001/scene-art/v2/scene-01/gao-001-scene-01-cover-b.webp?${CACHE_BUST}`,
    ] as const,
    desk: `/training/gao-001/scene-art/v2/scene-01/gao-001-scene-01-desk.webp?${CACHE_BUST}`,
  },
  "scene-02": {
